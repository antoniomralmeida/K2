...
import (
	...
	"github.com/antoniomralmeida/k2/internal/olivia/modules/start"
	"github.com/antoniomralmeida/k2/internal/olivia/user"
...
func SocketHandle(w http.ResponseWriter, r *http.Request) {
	...
	inits.Log(color.FgGreen.Render("A new connection has been opened"), inits.Info)
