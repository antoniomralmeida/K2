...
func InitTemplates() {
	...
	wd := inits.GetHomeDir()
	T["login"] = Minify("text/html", wd+"/web/login.gohtml", true)
	T["home"] = Minify("text/html", wd+"/web/home.gohtml", true)
	T["404"] = Minify("text/html", wd+"/web/404.gohtml", true)
	T["face"] = Minify("text/html", wd+"/web/face.gohtml", true)
	T["sigup"] = Minify("text/html", wd+"/web/register.gohtml", true)
